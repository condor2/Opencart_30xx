...
class ControllerExtensionPaymentGlobalpayRemote extends Controller {
	public function index() {
		...
		if ($this->config->get('payment_globalpay_remote_googlepay_status') == 1 && $this->config->get('payment_google_pay_status') == 1 && $this->config->get('payment_google_pay_merchant_gateway') == 'globalpayments') {
