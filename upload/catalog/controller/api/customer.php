...
class ControllerApiCustomer extends Controller {
	public function index() {
		...
		if (!isset($this->session->data['api_id'])) {
			...
			// Customer Group
			if ($this->customer->isLogged() && ($this->customer->getGroupId() == $this->request->post['customer_group_id'])) {
				$customer_group_id = $this->request->post['customer_group_id'];
			} elseif ((is_array($this->config->get('config_customer_group_display')) && in_array($this->request->post['customer_group_id'], $this->config->get('config_customer_group_display'))) || ($this->config->get('config_customer_group_id') == $this->request->post['customer_group_id'])) {
				$customer_group_id = $this->request->post['customer_group_id'];
			} else {
