...
class ModelExtensionPaymentSquareup extends Model {
	...
	private function paymentIsDue($order_recurring_id) {
		...
		switch ($frequency) {
			case 'day': $time_interval = 24 * 3600;
				break;
			case 'week': $time_interval = 7 * 24 * 3600;
				break;
			case 'semi_month': $time_interval = 15 * 24 * 3600;
				break;
			case 'month': $time_interval = 30 * 24 * 3600;
				break;
			case 'year': $time_interval = 365 * 24 * 3600;
				break;
		}
