...
INSERT INTO `oc_event` (`event_id`, `code`, `trigger`, `action`, `status`) VALUES
(46, 'admin_currency_add', 'admin/model/localisation/currency/addCurrency/after', 'event/currency', 1);
INSERT INTO `oc_event` (`event_id`, `code`, `trigger`, `action`, `status`) VALUES
(47, 'admin_currency_edit', 'admin/model/localisation/currency/editCurrency/after', 'event/currency', 1);
INSERT INTO `oc_event` (`event_id`, `code`, `trigger`, `action`, `status`) VALUES
(48, 'admin_setting', 'admin/model/setting/setting/editSetting/after', 'event/currency', 1);
